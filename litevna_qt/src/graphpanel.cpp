...
GraphPanel::GraphPanel( QWidget *parent ) : QWidget(parent), ui( new Ui::GraphPanel )
{
    ui->setupUi( this );
    ...
    for( int i = 0; i < (int)series.size(); i++ ) {
        ...
        axisY[i]->setLabelsColor( QColor( 250, 250, 250 ) );
        ...
        chart->setBackgroundBrush( QColor( 48, 47, 47 ) );
